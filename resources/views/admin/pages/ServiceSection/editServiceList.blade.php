...
<div class="shadow p-4 d-flex justify-content-between align-items-center ">
    ...
    <div>
        <a href="{{ route('list.service') }}" class="btn btn-info p-2 text-lg rounded-pill">Services List</a>
                    ...
                    <div class="card-body">
                        <form action="{{ route('serviceUpdate', $service->id) }}" method="post"
                                ...
                                <div class="col-md-6">
                                    <div class="form-outline">
                                        <label class="form-label mt-2 fw-bold " for="form11Example1">Service
                                            Name:</label>
                                        <input required value="{{ $service->service_name }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-outline">
                                        ...
                                        <input required value="{{ $service->description }}" placeholder="Service Title"
                                            type="text" id="form11Example1" name="description" class="form-control" />
                                    </div>
                                    <div class="mt-2">
                                        @error('description')
                                        <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="text-center w-25 mx-auto mt-3">
                                <button type="submit"
                                    class="btn btn-info p-2 text-lg  rounded-pill col-md-10 amn">Create</button>
                            </div>
                        </form>
                    </div>
                </div>
