...
<div class="shadow p-4 d-flex justify-content-between align-items-center ">
    ...
    <div>
        <a href="{{ route('organization.designation') }}" class="btn btn-info p-2 text-lg rounded-pill"><i
...
<div class="container my-5 py-5">
    ...
    <div class="fw-normal mb-4">
        <h2 class="fw-normal fs-5 mx-auto text-center rounded-pill p-2 w-50 mb-5
            @if ($designations->count() > 0) bg-info
            @else
        ...
        <table class="table align-middle mb-4 text-center bg-white">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info rounded-pill fw-bold text-white"
