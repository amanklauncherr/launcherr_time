...
<div class="shadow p-4 d-flex justify-content-between align-items-center ">
    ...
    <div>
        <a href="{{ route('leave.myLeave') }}" class="btn btn-info p-2 px-3 text-lg rounded-pill me-3">Leave
            Status</a>
        <a href="{{ route('leave.myLeaveBalance') }}" class="btn btn-info p-2 px-3 text-lg rounded-pill">Leave
            Balance</a>
    </div>
</div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12 ml-10">
                                        <div class="form-outline amn">
                                            <label class="form-label mt-2 fw-bold" for="form11Example1">Leave
                                                Type</label>
                                ...
                                <div>
                                    ...
                                    <textarea name="description" required placeholder="Write Your Reason Here..."
                                        type="text" id="form11Example1" class="form-control" cols="30"
                                        rows="10"></textarea>
                                </div>
                                <div class="text-center w-25 mx-auto mt-3">
                                    <button type="submit"
                                        class="btn btn-info p-2 text-lg  rounded-pill col-md-10 buttons">Submit</button>
                                </div>
                        </form>
                    </div>
                </div>
