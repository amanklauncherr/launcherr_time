...
<div class="shadow p-4 d-flex justify-content-between align-items-center ">
    ...
    <div>
        <a href="{{ route('manageEmployee.addEmployee') }}" class="btn btn-info p-2 text-lg rounded-pill">Add New
            Employee</a>
    </div>
</div>
<div class="mt-5 py-3">
    ...
    <div class="float-end mb-5">
        <button onclick="printContent('printDiv')" class="btn btn-info text-capitalize border-0"
