...
<div class="shadow p-4 d-flex justify-content-between align-items-center ">
    <h4 class="text-uppercase">Edit Payroll</h4>
    <div>
        <a href="{{ route('payroll.view') }}" class="btn btn-info p-2 text-lg rounded-pill"><i
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('payrollUpdate', $payroll->id) }}">
                            ...
                            <div class="mt-3 w-25 mx-auto text-center">
                                <button type="submit"
                                    class="btn btn-info p-2 text-lg rounded-pill col-md-10 amn">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
