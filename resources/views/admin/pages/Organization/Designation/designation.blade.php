...
<div class="shadow p-4 d-flex justify-content-between align-items-center ">
    ...
    <div>
        <a href="{{ route('organization.designationList') }}" class="btn btn-info p-2 text-lg rounded-pill"><i
            ...
            <div class="card-body">
                <form action="{{ route('organization.designation.store') }}" method="post">
                    ...
                    <div class="text-center w-25 mx-auto">
                        <button type="submit" class="btn btn-info p-2 rounded amn">Register</button>
                    </div>
                </form>
            </div>
        </div>
