...
<div class="shadow p-4 d-flex justify-content-between align-items-center ">
    ...
    <div>
        <a href="{{ route('manageEmployee.ViewEmployee') }}" class="btn btn-info px-3 p-2 text-lg rounded-pill"><i
...
<div class="container my-5 py-5">
    ...
    <section>
       ...
       name="phone" class="form-control" pattern="^(?:\+91|91)?[789]\d{9}$"
       title="Enter a valid Indian phone number with optional +91 or 91 preceding the number" />
