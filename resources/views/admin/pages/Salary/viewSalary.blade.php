...
<div class="shadow p-4 d-flex justify-content-between align-items-center">
    ...
    <div>
        <a href="{{ route('salary.create.form') }}" class="btn btn-info p-2 text-lg rounded-pill">Create New
            Salary</a>
    </div>
</div>
    ...
    <table class="table align-middle mb-4 text-center bg-white">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-info rounded-pill" href="{{ route('salaryEdit', $salary->id) }}"><i
