...
<div class="shadow p-4 d-flex justify-content-between align-items-center ">
    ...
    <div>
        <a href="{{ route('payroll.create') }}" class="btn btn-info p-2 text-lg rounded-pill">Create New Payroll</a>
    </div>
</div>
<div class="  my-5 py-5">
    <div class="d-flex justify-content-between align-items-center mb-5">
        ...
        <a href="{{ route('allPayrollList') }}" class="btn btn-info text-capitalize border-0"
